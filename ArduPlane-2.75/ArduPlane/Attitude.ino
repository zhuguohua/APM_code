...
static void set_servos(void)
{
    ...
    //channel_throttle->servo_out = channel_throttle->servo_out >= 50 ? (100 - channel_throttle->servo_out) : channel_throttle->servo_out;
	...
	//ԭ�治����if (control_mode != AUTO)���жϣ���@zhu�޸�
	if (ui8_auto_ctrl_throttle == 1)
	{
    ...
    //g.rc_5.output_ch(CH_5);// comment by Guohua Zhu
